/**
 * City Lines Start Screen Controller
 *
 * Factory function that sets up all citylines-specific start screen logic,
...
/** Controller interface returned by setupCityLinesStartScreen */
  ...
  return {
    ...
    async init(container: HTMLDivElement) {
      ...
      if (gpuLoader?.hasSheet(tileBundleName)) {
        ...
        character = new Character('news_hound', gpuLoader, 0.83);
