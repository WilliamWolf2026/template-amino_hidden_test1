...
The scaffold uses a custom screen manager instead of a traditional router. Screens are registered in configuration and switched via signals.
...
```typescript
import type { ScreenProps } from '~/scaffold/systems/screens';
