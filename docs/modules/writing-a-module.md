...
The tuning schema makes your module's parameters appear in the [Tuning Panel](../core/components/tuning-panel.md) under the green **Modules** section.
...
- [Tuning Panel](../core/components/tuning-panel.md) -- How module tuning appears in the panel
