...
The core audio system provides engine-agnostic audio management using Howler.js.
...
Browsers require user interaction before playing audio. The core system handles this:
...
Define sounds using the core `SoundDefinition` type:
