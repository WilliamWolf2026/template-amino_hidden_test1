...
See `src/core/dev/bindings.ts` for the integration point.

## File Locations

| File | Purpose |
|------|---------|
| `src/core/dev/EasingPicker.ts` | Component implementation |
| `src/core/dev/bindings.ts` | Tweakpane integration |
