...
See also: [architecture-map.md](architecture-map.md), [entry-point-map.md](entry-point-map.md)
...
graph LR
    ...
    ROADS --> RT["RoadTile xN (Container)"]
    ...
    DECO --> DECOSPRITE["Sprite xN\ntree / bush / flower"]
    CLG --> LAND["landmarksContainer"]
    LAND --> LM["Landmark xN (Container)"]
...
| ProgressBar | Container | `src/modules/primitives/progress-bar/renderers/pixi.ts` |
| SpriteButton | Container | `src/modules/primitives/sprite-button/renderers/pixi.ts` |
| DialogueBox | Container | `src/modules/primitives/dialogue-box/renderers/pixi.ts` |
| CharacterSprite | Container | `src/modules/primitives/character-sprite/renderers/pixi.ts` |
| AvatarPopup | Container | `src/modules/prefabs/avatar-popup/renderers/pixi.ts` |
